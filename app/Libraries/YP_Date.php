...
class YP_Date
{
     ...
     * @param string $type 比较跨度
     *
     * @return integer
     */
    public function dateDiff($date, $type = "d")
    {
        $__DAYS_PER_WEEK__    = (7);
        ...
        $__DIFF_DAYS = ($this->parse($date) - $this->date) / $__SECONDS_IN_A_DAY__;
        switch ($type) {
            case "y"://转换成年
                $__DIFF_DAYS = $__DIFF_DAYS / $__DAYS_PER_YEAR__;
                break;
            case "M"://转换成月
                $__DIFF_DAYS = $__DIFF_DAYS / $__DAYS_PER_MONTH__;
                break;
            case "w"://转换成星期
                $__DIFF_DAYS = $__DIFF_DAYS / $__DAYS_PER_WEEK__;
                break;
            case "h"://转换成小时
                $__DIFF_DAYS = $__DIFF_DAYS * $__HOURS_IN_A_DAY__;
                break;
            case "m"://转换成分钟
                $__DIFF_DAYS = $__DIFF_DAYS * $__MINUTES_IN_A_DAY__;
                break;
            case "s"://转换成秒
                $__DIFF_DAYS = $__DIFF_DAYS * $__SECONDS_IN_A_DAY__;
                break;
        }
    ...
    {
        return (new YP_Date(mktime(0, 0, 0, $this->month, 1, $this->year)));
    }
    ...
    {
        return (new YP_Date(mktime(0, 0, 0, 1, 1, $this->year)));
    }
    ...
    {
        return (new YP_Date(mktime(0, 0, 0, $this->month + 1, 0, $this->year)));
    }
    ...
    {
        return (new YP_Date(mktime(0, 0, 0, 1, 0, $this->year + 1)));
    }
    ...
    public function dateAdd($number = 0, $interval = "d")
    {
        ...
        return (new YP_Date(mktime($hours, $minutes, $seconds, $month, $day, $year)));
